...
venue: "UCSF"        # brief name of host site without address (e.g., "Euphoric State University")
...
humantime: "Saturday: 9:00 - 5:00, Sunday: 9:30 - 5:30"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
helper: ["Amber Bahorik", "Martin Frigaard"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:  http://pad.software-carpentry.org/2018-03-10-UCSF-R  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 42687836468          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
